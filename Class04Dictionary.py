...
k1 != k2 !=.....!=kn
v1 = v2 =.....=vn
4.In a list both keys and values have no restrictions on type(Any type of key or value can be used)
'''
...
#printing/accessing dictionary key values
print(my_dic1.get(2)) #OP : b  [value of key 2]
print(my_dic3.get(1)[2]) #OP : 3 [ key 1 is [1,2,3,4].So, list key 1[2] is 3 ]
print(my_dic1.get(3)) #OP : None

# Adding/changing/Accessing/Popping elements in dictionary
my_dic2[2] = "i"
...
#print( my_dic1[3] ) --> will give error
...
#printing item(pair) , keys and values
...
#list of keys(getting)
print( list(dic.keys()) )

#list of values(getting)
print( list(dic.values()) )

#list of items/pairs(getting)
